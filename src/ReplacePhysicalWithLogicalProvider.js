 ...
 */
class ReplacePhysicalWithLogicalProvider {
	...
	createCommandCodeActionQuickFix(diagnostic) {
		const action = new vscode.CodeAction(
			`Replace 💪 "${diagnostic.term.found}" with "${diagnostic.term.replacement}" 🧠.`,
...
module.exports = ReplacePhysicalWithLogicalProvider;
